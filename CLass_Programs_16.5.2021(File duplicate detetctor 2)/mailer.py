...
# string to store the body of the mail
    body = "Attached here is the file that contains the hourly report along with hashcodes of the files and duplicates which was recorded on: "+datetime.now().strftime("%d_%m_%Y-%I_%M")
